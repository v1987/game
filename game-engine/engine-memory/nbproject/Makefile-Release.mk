...
${OBJECTDIR}/SMULogicManager.o: SMULogicManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SMULogicManager.o SMULogicManager.cpp
...
${OBJECTDIR}/ShareMemAO.o: ShareMemAO.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ShareMemAO.o ShareMemAO.cpp

${OBJECTDIR}/ShareMemAPI.o: ShareMemAPI.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ShareMemAPI.o ShareMemAPI.cpp
